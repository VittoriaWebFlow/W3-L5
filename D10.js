...
const deleteOne = function (str,  Stringa){
  if(Stringa){
    return str.slice(1)
}else {
...
console.log(deleteOne("Vittoria", true))
console.log(deleteOne("Verde", false))
...
console.log(isThisAnEmail("vittoriasacchi7@gmail.com", true))
...
const isTodayMyBirthday = function(){
  ...
  return today.getDate() === myBirthday.date && today.getMonth() === myBirthday.month
}
